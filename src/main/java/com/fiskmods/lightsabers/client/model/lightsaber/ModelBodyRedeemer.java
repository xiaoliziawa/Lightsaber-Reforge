...
public class ModelBodyRedeemer extends LegacyModelBase
{
    ...
    public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5)
    {
        ...
        LegacyGlState.glTranslatef(grip1.offsetX, grip1.offsetY, grip1.offsetZ);
        LegacyGlState.glTranslatef(grip1.rotationPointX * f5, grip1.rotationPointY * f5, grip1.rotationPointZ * f5);
        ...
        LegacyGlState.glPushMatrix();
        LegacyGlState.glTranslatef(bodyPart4_1.offsetX, bodyPart4_1.offsetY, bodyPart4_1.offsetZ);
        LegacyGlState.glTranslatef(bodyPart4_1.rotationPointX * f5, bodyPart4_1.rotationPointY * f5, bodyPart4_1.rotationPointZ * f5);
        ...
        LegacyGlState.glPopMatrix();
        LegacyGlState.glPushMatrix();
        LegacyGlState.glTranslatef(bodyPart2_1.offsetX, bodyPart2_1.offsetY, bodyPart2_1.offsetZ);
        LegacyGlState.glTranslatef(bodyPart2_1.rotationPointX * f5, bodyPart2_1.rotationPointY * f5, bodyPart2_1.rotationPointZ * f5);
        LegacyGlState.glScaled(1.0D, 0.8D, 1.0D);
        LegacyGlState.glTranslatef(-bodyPart2_1.offsetX, -bodyPart2_1.offsetY, -bodyPart2_1.offsetZ);
        LegacyGlState.glTranslatef(-bodyPart2_1.rotationPointX * f5, -bodyPart2_1.rotationPointY * f5, -bodyPart2_1.rotationPointZ * f5);
        ...
        LegacyGlState.glPopMatrix();
        LegacyGlState.glPushMatrix();
        LegacyGlState.glTranslatef(bodyPart3_1.offsetX, bodyPart3_1.offsetY, bodyPart3_1.offsetZ);
        LegacyGlState.glTranslatef(bodyPart3_1.rotationPointX * f5, bodyPart3_1.rotationPointY * f5, bodyPart3_1.rotationPointZ * f5);
        LegacyGlState.glScaled(1.0D, 0.8D, 1.0D);
        LegacyGlState.glTranslatef(-bodyPart3_1.offsetX, -bodyPart3_1.offsetY, -bodyPart3_1.offsetZ);
        LegacyGlState.glTranslatef(-bodyPart3_1.rotationPointX * f5, -bodyPart3_1.rotationPointY * f5, -bodyPart3_1.rotationPointZ * f5);
        ...
        LegacyGlState.glPopMatrix();
        LegacyGlState.glPushMatrix();
        LegacyGlState.glTranslatef(bodyPart6_1.offsetX, bodyPart6_1.offsetY, bodyPart6_1.offsetZ);
        LegacyGlState.glTranslatef(bodyPart6_1.rotationPointX * f5, bodyPart6_1.rotationPointY * f5, bodyPart6_1.rotationPointZ * f5);
        LegacyGlState.glScaled(1.0D, 0.8D, 1.0D);
        LegacyGlState.glTranslatef(-bodyPart6_1.offsetX, -bodyPart6_1.offsetY, -bodyPart6_1.offsetZ);
        LegacyGlState.glTranslatef(-bodyPart6_1.rotationPointX * f5, -bodyPart6_1.rotationPointY * f5, -bodyPart6_1.rotationPointZ * f5);
        ...
        LegacyGlState.glPopMatrix();
        LegacyGlState.glPushMatrix();
        LegacyGlState.glTranslatef(bodyPart5_1.offsetX, bodyPart5_1.offsetY, bodyPart5_1.offsetZ);
        LegacyGlState.glTranslatef(bodyPart5_1.rotationPointX * f5, bodyPart5_1.rotationPointY * f5, bodyPart5_1.rotationPointZ * f5);
        LegacyGlState.glScaled(1.0D, 0.8D, 1.0D);
        LegacyGlState.glTranslatef(-bodyPart5_1.offsetX, -bodyPart5_1.offsetY, -bodyPart5_1.offsetZ);
        LegacyGlState.glTranslatef(-bodyPart5_1.rotationPointX * f5, -bodyPart5_1.rotationPointY * f5, -bodyPart5_1.rotationPointZ * f5);
        ...
        LegacyGlState.glPopMatrix();
        LegacyGlState.glPushMatrix();
        LegacyGlState.glTranslatef(bodyPart1_1.offsetX, bodyPart1_1.offsetY, bodyPart1_1.offsetZ);
        LegacyGlState.glTranslatef(bodyPart1_1.rotationPointX * f5, bodyPart1_1.rotationPointY * f5, bodyPart1_1.rotationPointZ * f5);
        LegacyGlState.glScaled(1.0D, 0.8D, 1.0D);
        LegacyGlState.glTranslatef(-bodyPart1_1.offsetX, -bodyPart1_1.offsetY, -bodyPart1_1.offsetZ);
        LegacyGlState.glTranslatef(-bodyPart1_1.rotationPointX * f5, -bodyPart1_1.rotationPointY * f5, -bodyPart1_1.rotationPointZ * f5);
