...
public class ModelSwitchSectionRedeemer extends LegacyModelBase
{
    ...
    public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5)
    {
        ...
        LegacyGlState.glPushMatrix();
        LegacyGlState.glTranslatef(upperSideButton1.offsetX, upperSideButton1.offsetY, upperSideButton1.offsetZ);
        LegacyGlState.glTranslatef(upperSideButton1.rotationPointX * f5, upperSideButton1.rotationPointY * f5, upperSideButton1.rotationPointZ * f5);
