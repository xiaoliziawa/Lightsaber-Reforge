...
public class ModelSwitchSectionVaid extends LegacyModelBase
{
    ...
    public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5)
    {
        ...
        LegacyGlState.glPushMatrix();
        LegacyGlState.glTranslatef(upperButton1.offsetX, upperButton1.offsetY, upperButton1.offsetZ);
        LegacyGlState.glTranslatef(upperButton1.rotationPointX * f5, upperButton1.rotationPointY * f5, upperButton1.rotationPointZ * f5);
        ...
        LegacyGlState.glPopMatrix();
        LegacyGlState.glPushMatrix();
        LegacyGlState.glTranslatef(lowerButton1.offsetX, lowerButton1.offsetY, lowerButton1.offsetZ);
        LegacyGlState.glTranslatef(lowerButton1.rotationPointX * f5, lowerButton1.rotationPointY * f5, lowerButton1.rotationPointZ * f5);
        LegacyGlState.glScaled(0.3D, 0.3D, 0.3D);
        LegacyGlState.glTranslatef(-lowerButton1.offsetX, -lowerButton1.offsetY, -lowerButton1.offsetZ);
        LegacyGlState.glTranslatef(-lowerButton1.rotationPointX * f5, -lowerButton1.rotationPointY * f5, -lowerButton1.rotationPointZ * f5);
