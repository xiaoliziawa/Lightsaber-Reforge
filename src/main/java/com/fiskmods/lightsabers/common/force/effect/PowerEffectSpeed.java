...
public class PowerEffectSpeed extends PowerEffectInstant
{
    ...
    {
        return new String[] {PowerDesc.create("effect", PowerDesc.format("%s %s%s", PowerDesc.translateFormatted("forcepower.stat.multiply", Unit.SPEED, 2), ChatFormatting.GRAY, duration), Target.CASTER)};
    }
}
