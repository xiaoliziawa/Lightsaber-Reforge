...
public class PowerEffectResist extends PowerEffectInstant
{
    ...
    {
        return new String[] {PowerDesc.create("effect", PowerDesc.format("%s %s%s", PowerDesc.translateFormatted("forcepower.stat.divide", Unit.ENERGY_DAMAGE, getModifierAmount(amplifier)), ChatFormatting.GRAY, duration), Target.CASTER)};
    }
