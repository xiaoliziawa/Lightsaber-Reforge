...
public class StructureJediTemple extends Structure
{
    ...
    public StructureJediTemple(float ruin, LevelAccessor world, int x, int y, int z)
    {
        super(world, x, y, z);
        ruination = ruin;
    }
    ...
    public void placeBlock(int x, int y, int z, Block block, int metadata, int flags)
    {
        if (ruination > 0)
        {
            if (block == LegacyStructureBlocks.leaves || block == LegacyStructureBlocks.water)
            {
                return;
            }
            ...
            else if (block == LegacyStructureBlocks.planks && metadata == 4 && rand.nextFloat() < ruination)
            {
                if (rand.nextBoolean())
                {
                    super.placeBlock(x, y, z, LegacyStructureBlocks.wooden_slab, rand.nextBoolean() ? 4 : 12, flags);
                }
                else
                {
                    super.placeBlock(x, y, z, LegacyStructureBlocks.acacia_stairs, rand.nextInt(8), flags);
                }
            }
            else if (block == LegacyStructureBlocks.water
                    || block == LegacyStructureBlocks.stained_hardened_clay
    ...
    {
        BlockPos surfacePos = new BlockPos(xCoord, yCoord, zCoord);
        Block topBlock = worldObj.getBlockState(surfacePos).getBlock();
        Block fillerBlock = worldObj.getBlockState(surfacePos.below()).getBlock();
        int topBlockMeta = 0;
        ...
        for (int layer = 0; layer < 2; ++layer)
        {
            ...
            setBlock(LegacyStructureBlocks.planks, 4, 5, 0, 13);
            setBlock(LegacyStructureBlocks.planks, 4, 5, 0, 21);
            ...
            for (int i = 0; i < 2; ++i)
            {
                ...
                setBlock(LegacyStructureBlocks.planks, 4, 4 + i, 0, 12);
                setBlock(LegacyStructureBlocks.planks, 4, 4 + i, 0, 22);
                ...
                for (int j = 0; j < 3; ++j)
                {
                    setBlock(LegacyStructureBlocks.stained_glass_pane, 3, i, 6 + j, 7);
            ...
            for (int i = 0; i < 3; ++i)
            {
                ...
                setBlock(LegacyStructureBlocks.stained_glass_pane, 3, 2, 1 + i, 7);
                setBlock(LegacyStructureBlocks.stained_glass_pane, 3, 0, 9 + i, 7);
                setBlock(LegacyStructureBlocks.planks, 4, 3 + i, 0, 11);
                setBlock(LegacyStructureBlocks.planks, 4, 2 + i, 0, 23);
            ...
            for (int i = 0; i < 5; ++i)
            {
                ...
                setBlock(LegacyStructureBlocks.planks, 4, i, 0, 8);

                for (int j = 0; j < 2; ++j)
                {
                    setBlock(LegacyStructureBlocks.planks, 4, i, 0, 24 + j);
                }
            }
            ...
            for (int i = 0; i < 6; ++i)
            {
                for (int j = 0; j < 2; ++j)
                {
                    setBlock(LegacyStructureBlocks.planks, 4, i, 0, 9 + j);
                }
            }

            for (int i = 0; i < 7; ++i)
            {
                setBlock(i % 2 == 0 ? ModBlocks.lightForcestone : LegacyStructureBlocks.stained_hardened_clay, i % 2 == 0 ? 0 : 3, 5, 0, 14 + i);
            }
            ...
            for (int i = 0; i < 8; ++i)
            {
                ...
                for (int j = 0; j < 5; ++j)
                {
                    ...
                    {
                        setBlock(i == 3 ? LegacyStructureBlocks.planks : ModBlocks.lightForcestone, i == 3 ? 4 : 0, 5, i, 24 + j);
                    }
                    else
                    {
                        setBlock(i == 2 || i == 3 ? LegacyStructureBlocks.planks : ModBlocks.lightForcestone, i == 2 || i == 3 ? 4 : 0, 5, i, 24 + j);
                    }
                }
            }
            ...
            for (int i = 0; i < 9; ++i)
            {
                ...
                setBlock(i < 3 || i > 5 ? ModBlocks.lightForcestone : LegacyStructureBlocks.stained_hardened_clay, i < 3 || i > 5 ? 0 : 3, 4, 0, 13 + i);
            ...
            for (int i = 0; i < 10; ++i)
            {
                ...
                setBlock(LegacyStructureBlocks.planks, 4, 6, 2, 12 + i);
                setBlock(LegacyStructureBlocks.planks, 4, 6, 3, 12 + i);
                setBlock(ModBlocks.lightForcestone, 0, 6, 4, 12 + i);
            }

            for (int i = 0; i < 11; ++i)
            {
                setBlock(i < 2 || i > 8 || i == 5 ? ModBlocks.lightForcestone : LegacyStructureBlocks.stained_hardened_clay, i < 2 || i > 8 || i == 5 ? 0 : 3, 3, 0, 12 + i);
            }
            ...
            for (int i = 0; i < 12; ++i)
            {
                ...
                setBlock(LegacyStructureBlocks.stained_glass_pane, 3, 5, 6, 11 + i);
                setBlock(LegacyStructureBlocks.stained_glass_pane, 3, 5, 7, 11 + i);
                setBlock(i < 2 || i > 3 ? ModBlocks.lightForcestone : LegacyStructureBlocks.stained_hardened_clay, i < 2 || i > 3 ? 0 : 3, 2, 0, 11 + i);

                for (int j = 0; j < 2; ++j)
                {
                    setBlock(LegacyStructureBlocks.planks, 4, j, 0, 26 + i);
                }
            }

            for (int i = 0; i < 13; ++i)
            {
                setBlock((i < 1 || i > 2) && i != 5 ? ModBlocks.lightForcestone : LegacyStructureBlocks.stained_hardened_clay, (i < 1 || i > 2) && i != 5 ? 0 : 3, 1, 0, 11 + i);
                setBlock(i == 0 || i == 12 ? ModBlocks.lightForcestone : LegacyStructureBlocks.stained_hardened_clay, i == 0 || i == 12 ? 0 : 3, 0, 0, 11 + i);
            }
            ...
            for (int i = 0; i < 2; ++i)
            {
                ...
                for (int j = 0; j < 2; ++j)
                {
                    ...
                    setBlock(LegacyStructureBlocks.water, 0, 6 + i, -1, 7 + j);
                    setBlock(LegacyStructureBlocks.water, 0, 6 + i, -1, 20 + j);
                ...
                for (int j = 0; j < 3; ++j)
                {
                    setBlock(LegacyStructureBlocks.planks, 4, 6, y, j);
                    setBlock(LegacyStructureBlocks.planks, 4, 7, y, 1 + j);
                    setBlock(LegacyStructureBlocks.planks, 4, 8, y, 1 + j);
                    setBlock(LegacyStructureBlocks.planks, 4, 9, y, 2 + j);
                    setBlock(LegacyStructureBlocks.planks, 4, 10, y, 3 + j);
                    setBlock(LegacyStructureBlocks.planks, 4, 6, y, -j + 28);
                    setBlock(LegacyStructureBlocks.planks, 4, 7, y, -(1 + j) + 28);
                    setBlock(LegacyStructureBlocks.planks, 4, 8, y, -(1 + j) + 28);
                    setBlock(LegacyStructureBlocks.planks, 4, 9, y, -(2 + j) + 28);
                    setBlock(LegacyStructureBlocks.planks, 4, 10, y, -(3 + j) + 28);
                    setBlock(LegacyStructureBlocks.planks, 4, 14 + i, 0, 13 + j);
                    setBlock(ModBlocks.lightForcestone, 0, 12, 1 + j, 12 + i * 4);
                    setBlock(LegacyStructureBlocks.stained_glass_pane, 3, i, 6 + j, 4);
                    setBlock(LegacyStructureBlocks.stained_glass_pane, 3, i, 6 + j, 24);
                ...
                for (int j = 0; j < 4; ++j)
                {
                    setBlock(LegacyStructureBlocks.planks, 4, 14, y, 8 + j);
                    setBlock(LegacyStructureBlocks.planks, 4, 14, y, 17 + j);
                ...
                for (int j = 0; j < 5; ++j)
                {
                    setBlock(LegacyStructureBlocks.planks, 4, 11, y, 3 + j);
                    setBlock(LegacyStructureBlocks.planks, 4, 11, y, -(3 + j) + 28);
                    setBlock(LegacyStructureBlocks.planks, 4, i, 0, 21 + j);
                }

                for (int j = 0; j < 6; ++j)
                {
                    setBlock(LegacyStructureBlocks.planks, 4, j, 4, 26 + i);
                }

                for (int j = 0; j < 17; ++j)
                {
                    setBlock(LegacyStructureBlocks.planks, 4, 13, y, 6 + j);
                }

                for (int j = 0; j < 19; ++j)
                {
                    setBlock(LegacyStructureBlocks.planks, 4, 12, y, 5 + j);
                }

                setBlock(ModBlocks.lightForcestone, 1, 2, 3, i);
                setBlock(LegacyStructureBlocks.grass, 0, i, 0, 12);
                setBlock(LegacyStructureBlocks.grass, 0, i, 0, 16);
                ...
                setBlock(LegacyStructureBlocks.planks, 4, 2 + i, 0, 11 + i);
                setBlock(LegacyStructureBlocks.planks, 4, 2 + i, 0, 17 - i);
                setBlock(LegacyStructureBlocks.planks, 4, 4, 0, 10 + i);
                setBlock(LegacyStructureBlocks.planks, 4, 4, 0, 17 + i);
                setBlock(LegacyStructureBlocks.planks, 4, 5, 0, 11 + i * 6);
                setBlock(ModBlocks.lightForcestone, 1, i, 4, 25);
                setBlock(LegacyStructureBlocks.stained_glass, 3, i, 4, 29);
                setBlock(LegacyStructureBlocks.planks, 4, i, 0, 29);
                ...
                setBlock(LegacyStructureBlocks.water, 0, 5 + i, -1, 6);
                setBlock(LegacyStructureBlocks.water, 0, 8, -1, 8 + i);
                setBlock(LegacyStructureBlocks.water, 0, 5 + i, -1, 22);
                setBlock(LegacyStructureBlocks.water, 0, 8, -1, 19 + i);
                ...
                setBlock(LegacyStructureBlocks.stained_glass_pane, 3, 8 + i, 5, 1);
                setBlock(LegacyStructureBlocks.stained_glass_pane, 3, 13, 5, 5 + i);
                setBlock(LegacyStructureBlocks.stained_glass_pane, 3, 8 + i, 5, 27);
                setBlock(LegacyStructureBlocks.stained_glass_pane, 3, 13, 5, 22 + i);
                setBlock(LegacyStructureBlocks.stained_glass_pane, 3, 11, 5, 3 + i * 22);
            ...
            for (int i = 0; i < 3; ++i)
            {
                setBlock(LegacyStructureBlocks.stained_glass, 3, 15, 4, 13 + i);
                ...
                setBlock(LegacyStructureBlocks.planks, 4, 3, 0, 9 + i);
                setBlock(LegacyStructureBlocks.planks, 4, 3, 0, 17 + i);
                setBlock(ModBlocks.lightForcestone, 0, i, 4, 28);
                setBlock(LegacyStructureBlocks.planks, 4, 3 + i, 4, 28);
                ...
                setBlock(LegacyStructureBlocks.stained_glass_pane, 3, 0, 9 + i, 4);
                setBlock(LegacyStructureBlocks.stained_glass_pane, 3, 0, 9 + i, 24);
                setBlock(ModBlocks.lightForcestone, 0, 10, 5, 13 + i);
                setBlock(LegacyStructureBlocks.stained_glass_pane, 3, 10, 9 + i, 14);
                setBlock(LegacyStructureBlocks.stained_glass_pane, 3, 6 + i, 5, 0);
                setBlock(LegacyStructureBlocks.stained_glass_pane, 3, 9 + i, 5, 2);
                setBlock(LegacyStructureBlocks.stained_glass_pane, 3, 12, 5, 3 + i);
                setBlock(LegacyStructureBlocks.stained_glass_pane, 3, 14, 5, 6 + i);
                setBlock(LegacyStructureBlocks.stained_glass_pane, 3, 14, 5, 20 + i);
                setBlock(LegacyStructureBlocks.stained_glass_pane, 3, 12, 5, 23 + i);
                setBlock(LegacyStructureBlocks.stained_glass_pane, 3, 9 + i, 5, 26);
                setBlock(LegacyStructureBlocks.stained_glass_pane, 3, 6 + i, 5, 28);
                ...
                for (int j = 0; j < 3; ++j)
                {
                    ...
                    setBlock(ModBlocks.forcestoneSlab, 8, 15, 5, 9 + i + j * 4);
                    setBlock(LegacyStructureBlocks.planks, 4, 3 + i, 0, j);
                    setBlock(LegacyStructureBlocks.planks, 4, i, 0, 8 + j);
                    setBlock(LegacyStructureBlocks.planks, 4, i, 0, 18 + j);
                    setBlock(LegacyStructureBlocks.grass, 0, i, 0, 13 + j);
                    setBlock(LegacyStructureBlocks.stained_glass_pane, 3, 10, 6 + i, 13 + j);
                ...
                for (int j = 0; j < 5; ++j)
                {
                    setBlock(LegacyStructureBlocks.planks, 4, 4 + i, 0, 12 + j);
                    setBlock(LegacyStructureBlocks.planks, 4, 7 + j, 0, 13 + i);
            ...
            for (int i = 0; i < 4; ++i)
            {
                ...
                setBlock(LegacyStructureBlocks.stained_glass_pane, 3, 0, 8 + i, 28);
                setBlock(LegacyStructureBlocks.stained_glass_pane, 3, 14, 8 + i, 14);
                ...
                for (int j = 0; j < 9; ++j)
                {
                    setBlock(LegacyStructureBlocks.planks, 4, 17 + j, i, 8);
                    setBlock(LegacyStructureBlocks.planks, 4, 17 + j, i, 20);
                    setBlock(LegacyStructureBlocks.planks, 4, 27, i, 10 + j);
                    setBlock(LegacyStructureBlocks.planks, 4, 6, i, 31 + j);
                }
            }
            ...
            for (int i = 0; i < 5; ++i)
            {
                ...
                setBlock(LegacyStructureBlocks.planks, 4, 14, 0, 12 + i);
                ...
                for (int j = 0; j < 4; ++j)
                {
                    ...
                    setBlock(LegacyStructureBlocks.planks, 4, i, j, 41);
                }

                for (int j = 0; j < 10; ++j)
                {
                    setBlock(LegacyStructureBlocks.stained_glass, 3, i, 4, 30 + j);
                }
            }
            ...
            for (int i = 0; i < 8; ++i)
            {
                ...
                int metadata = block == LegacyStructureBlocks.stained_glass ? 3 : 0;

                for (int j = 0; j < 4; ++j)
                {
                    if (j > 0 || i > 4)
                    {
                        block = i < 2 ? ModBlocks.lightForcestone : (i < 4 || i == 6 ? LegacyStructureBlocks.stained_glass : ModBlocks.lightForcestone);
                        metadata = block == LegacyStructureBlocks.stained_glass ? 3 : 0;
                    }
            ...
            for (int i = 0; i < 9; ++i)
            {
                ...
                for (int j = 0; j < 10; ++j)
                {
                    setBlock(LegacyStructureBlocks.stained_glass, 3, 16 + j, 4, 10 + i);
                }
            }
            ...
            for (int i = 0; i < 11; ++i)
            {
                ...
                for (int j = 0; j < 6; ++j)
                {
                    setBlock(LegacyStructureBlocks.planks, 4, j, 0, 30 + i);
                }

                for (int j = 0; j < 11; ++j)
                {
                    setBlock(LegacyStructureBlocks.planks, 4, 16 + i, 0, 9 + j);
                }
            }
            ...
            for (int i = 0; i < 3; ++i)
            {
                setBlock(LegacyStructureBlocks.wooden_slab, 4, 20 + i, 0, 12);
                setBlock(LegacyStructureBlocks.wooden_slab, 4, 20 + i, 0, 16);
                setBlock(LegacyStructureBlocks.wooden_slab, 4, 2, 0, 34 + i);
                setBlock(ModBlocks.lightForcestoneStairs, i == 2 ? 0 : 3, i, 0, 32);
                setBlock(ModBlocks.lightForcestoneStairs, i == 2 ? 0 : 2, i, 0, 38);

                for (int j = 0; j < 5; ++j)
                {
                    setBlock(LegacyStructureBlocks.wooden_slab, 4, 19 + j, 0, 13 + i);

                    if (i < 2)
                    {
                        setBlock(LegacyStructureBlocks.wooden_slab, 4, i, 0, 33 + j);
                    }
                }
            }
            ...
            if (simulate)
            {
                ...
                for (int i = 0; i < coverage.size(); ++i)
                {
                    ...
                    if (!isWithinHorizontalGenerationBounds(p.posX, p.posZ))
                    {
                        continue;
                    }

                    while (y > 0 && !worldObj.getBlockState(mutablePos.set(p.posX, y - 1, p.posZ))
                            .isFaceSturdy(worldObj, mutablePos, Direction.UP))
                    {
                        placeBlock(
                                p.posX,
                                --y,
                                p.posZ,
                                fillerBlock.defaultBlockState(),
                    ...
                    {
                        if (!worldObj.isEmptyBlock(mutablePos.set(p.posX, y, p.posZ)))
                        {
                            placeBlock(
                                    p.posX,
                                    y,
                                    p.posZ,
                                    LegacyStructureBlocks.air.defaultBlockState(),
                                    Block.UPDATE_CLIENTS
                            );
                        }
                    }
    ...
    public void generateTree(Random random)
    {
        ...
        int leafCoverageI = Mth.ceil(leafCoverage);
        ...
        for (int x = -1; x < 2; ++x)
        {
            for (int z = -1; z < 2; ++z)
            {
                for (int y = 0; y < height; ++y)
                {
                    ...
                    {
                        setBlock(LegacyStructureBlocks.log, 0, x, y + 1, z);
                    }
                    else
                    {
                        y = height;
        ...
        setBlock(LegacyStructureBlocks.log, 0, 0, 1 + height, 0);

        for (int i = 0; i < 18 + random.nextInt(3); ++i)
        {
            ...
            int branchLength = (branchMin + random.nextInt(branchMax - branchMin + 1)
                    + branchMin + random.nextInt(branchMax - branchMin + 1)) / 2;
            for (int j = 0; j < branchLength; ++j)
            {
                Vec3 vec3 = new Vec3(0, j, 0)
                        .xRot(rotX * Mth.DEG_TO_RAD)
                        .yRot(rotY * Mth.DEG_TO_RAD);
                int branchX = Mth.floor(vec3.x);
                int branchY = Mth.floor(vec3.y);
                int branchZ = Mth.floor(vec3.z);

                setBlock(LegacyStructureBlocks.log, 0, branchX, 1 + height + branchY, branchZ);
                ...
                for (int x = -leafCoverageI; x <= leafCoverageI; ++x)
                {
                    for (int y = -leafCoverageI; y <= leafCoverageI; ++y)
                    {
                        ...
                        {
                            Block block = worldObj.getBlockState(new BlockPos(
                                    xCoord + branchX + x,
                                    yCoord + 1 + height + branchY + y,
                                    zCoord + branchZ + z
                            )).getBlock();

                            if (block != LegacyStructureBlocks.log)
                            {
                                Vec3 src = new Vec3(
                                        branchX + 0.5D,
                                        1 + height + branchY + 0.5D,
                                        branchZ + 0.5D
                                );
                                Vec3 dst = src.add(x, y, z);

                                if (src.distanceTo(dst) <= leafCoverage)
                                {
                                    setBlock(
                                            LegacyStructureBlocks.leaves,
                                            0,
                                            branchX + x,
                                            1 + height + branchY + y,
                                            branchZ + z
